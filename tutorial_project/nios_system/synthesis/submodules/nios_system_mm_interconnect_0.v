...
module nios_system_mm_interconnect_0 (
	...
	wire  [90:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> onchip_memory_s1_agent:cp_data
	...
	wire  [14:0] pio_output_s1_agent_m0_address;                                            // pio_output_s1_agent:m0_address -> pio_output_s1_translator:uav_address
	...
	wire  [91:0] pio_output_s1_agent_rf_source_data;                                        // pio_output_s1_agent:rf_source_data -> pio_output_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] pio_output_s1_agent_rsp_fifo_out_data;                                     // pio_output_s1_agent_rsp_fifo:out_data -> pio_output_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> pio_output_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // pio_output_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> pio_output_s1_agent:cp_channel
	...
	wire  [14:0] pio_input_s1_agent_m0_address;                                             // pio_input_s1_agent:m0_address -> pio_input_s1_translator:uav_address
	...
	wire  [91:0] pio_input_s1_agent_rf_source_data;                                         // pio_input_s1_agent:rf_source_data -> pio_input_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] pio_input_s1_agent_rsp_fifo_out_data;                                      // pio_input_s1_agent_rsp_fifo:out_data -> pio_input_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> pio_input_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // pio_input_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> pio_input_s1_agent:cp_channel
	...
	wire  [90:0] onchip_memory_s1_agent_rp_data;                                            // onchip_memory_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [90:0] pio_output_s1_agent_rp_data;                                               // pio_output_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [90:0] pio_input_s1_agent_rp_data;                                                // pio_input_s1_agent:rp_data -> router_007:sink_data
