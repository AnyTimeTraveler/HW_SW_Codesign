...
module nios_system_mm_interconnect_0 (
	...
	wire   [27:0] rs232_avalon_rs232_slave_agent_m0_address;                                 // rs232_avalon_rs232_slave_agent:m0_address -> rs232_avalon_rs232_slave_translator:uav_address
	...
	wire  [104:0] rs232_avalon_rs232_slave_agent_rf_source_data;                             // rs232_avalon_rs232_slave_agent:rf_source_data -> rs232_avalon_rs232_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] rs232_avalon_rs232_slave_agent_rsp_fifo_out_data;                          // rs232_avalon_rs232_slave_agent_rsp_fifo:out_data -> rs232_avalon_rs232_slave_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> rs232_avalon_rs232_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                     // rs232_avalon_rs232_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [7:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> rs232_avalon_rs232_slave_agent:cp_channel
	...
	wire   [27:0] lcd_control_slave_agent_m0_address;                                        // lcd_control_slave_agent:m0_address -> lcd_control_slave_translator:uav_address
	...
	wire  [104:0] lcd_control_slave_agent_rf_source_data;                                    // lcd_control_slave_agent:rf_source_data -> lcd_control_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] lcd_control_slave_agent_rsp_fifo_out_data;                                 // lcd_control_slave_agent_rsp_fifo:out_data -> lcd_control_slave_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> lcd_control_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                     // lcd_control_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> lcd_control_slave_agent:cp_channel
	...
	wire  [103:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> pio_output_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                     // pio_output_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> pio_output_s1_agent:cp_channel
	...
	wire          cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> pio_input_s1_agent:cp_valid
	wire  [103:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> pio_input_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                     // pio_input_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> pio_input_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> pio_input_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> pio_input_s1_agent:cp_endofpacket
	...
	wire  [103:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> sdram_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                     // sdram_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> sdram_s1_agent:cp_channel
	...
	wire  [103:0] rs232_avalon_rs232_slave_agent_rp_data;                                    // rs232_avalon_rs232_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [103:0] lcd_control_slave_agent_rp_data;                                           // lcd_control_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [103:0] pio_output_s1_agent_rp_data;                                               // pio_output_s1_agent:rp_data -> router_007:sink_data
	...
	wire          pio_input_s1_agent_rp_valid;                                               // pio_input_s1_agent:rp_valid -> router_008:sink_valid
	wire  [103:0] pio_input_s1_agent_rp_data;                                                // pio_input_s1_agent:rp_data -> router_008:sink_data
	wire          pio_input_s1_agent_rp_ready;                                               // router_008:sink_ready -> pio_input_s1_agent:rp_ready
	wire          pio_input_s1_agent_rp_startofpacket;                                       // pio_input_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          pio_input_s1_agent_rp_endofpacket;                                         // pio_input_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [103:0] cmd_demux_001_src3_data;                                                   // cmd_demux_001:src3_data -> cmd_mux_007:sink1_data
	...
	wire  [103:0] rsp_demux_007_src1_data;                                                   // rsp_demux_007:src1_data -> rsp_mux_001:sink3_data
	...
	wire          pio_input_s1_agent_rdata_fifo_src_valid;                                   // pio_input_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] pio_input_s1_agent_rdata_fifo_src_data;                                    // pio_input_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          pio_input_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_006:in_0_ready -> pio_input_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> pio_input_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> pio_input_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                         // pio_input_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> pio_input_s1_agent:rdata_fifo_sink_error
